...
# v0.10.6.1 — Recording and MediaFile ORM models removed. Recording
# metadata is stored exclusively in meeting.data['recordings'] (JSONB);
# the relational tables are being dropped by migration m331.
