...
// v0.10.6.1 — canonical playback routes (ADR-2). Producer writes;
// consumer reads. Null sub-field = no master for that type yet.
...
export interface RecordingData {
  ...
  playback_url?: RecordingPlaybackUrl | null; // v0.10.6.1 canonical (ADR-2)
}
