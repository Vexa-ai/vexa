...
__export(index_exports, {
  ...
  applyTranscriptTick: () => applyTranscriptTick,
  bootstrapConfirmed: () => bootstrapConfirmed,
  bootstrapSegments: () => bootstrapSegments,
  createTranscriptManager: () => createTranscriptManager,
  ...
  retractSegments: () => retractSegments,
