# Lite lane — human eyeball roll-up
...
skill contract (step 11) for the Lite lane.

## (a) Basic functionality

→ `lite/human-eyeball-basic.md`

## (b) Pack blast radius

→ `lite/human-eyeball-blast-radius.md`
...
Timestamp: <ISO-8601>
Refers-to:
  - lite/human-eyeball-basic.md (verdict: ___)
  - lite/human-eyeball-blast-radius.md (verdict: ___)
```
