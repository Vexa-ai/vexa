# Pack PR: [Pack] MS Teams diarization cutover — replace caption-driven audio gating with pyannote segmentation + blue-square correlation

Pack epic: https://github.com/Vexa-ai/vexa/issues/394
...
Evidence: `.agents/packs/pack-msteams-diarization-cutover/`

## Outcomes

CEO: Vexa's MS Teams transcripts no longer break when Teams' own caption stream
...
CTO: The MS Teams audio path in `services/vexa-bot/core/src/index.ts` switches
...
User: End users of the dashboard:
