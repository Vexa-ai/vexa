# Compose lane — human eyeball verdict: BASIC functionality
...
Whether the **overall user-facing surface** in the Compose lane behaves
...
|---|---|---|---|---|
| Dashboard loads | `http://localhost:42300/` | dashboard UI renders, no console errors | _operator to fill_ | _( )_ |
| Sign-in | use admin API token | logged-in dashboard with empty meeting list | _operator to fill_ | _( )_ |
| API docs | `http://localhost:42301/docs` | Swagger renders, /v1/bots endpoint visible | _operator to fill_ | _( )_ |
| MCP endpoint health | `http://localhost:42305/health` | 200 OK | _operator to fill_ | _( )_ |
