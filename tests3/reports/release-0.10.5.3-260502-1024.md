# Release validation report — `0.10.5.3-260502-1024`

_Generated 2026-05-02T07:34:47.362851Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1024` | 20 | 18 | 2 |
| `helm` | `0.10.5.3-260502-1024` | 13 | 10 | 3 |
| `lite` | `0.10.5.3-260502-1024` | 10 | 8 | 2 |
...
| status-webhooks-fire | Status-change webhooks fire for every transition when enabled in webhook_events | 5 | ✅ pass | helm: webhooks/e2e_status: 6 status-change webhook(s) fired: meeting.status_change |
...
| `containers` | ✅ pass | 109140 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 430 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1133 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 98 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 302 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91878 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 595 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5385 ms | 13 / 17 |
...
| `webhooks` | ✅ pass | 96550 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 306 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 576 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 394 ms | 2 / 2 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 248 ms | 1 / 1 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ✅ pass | 114705 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1597 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3314 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 102058 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9249 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 32443 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 2963 ms | 89 / 92 |
| `webhooks` | ✅ pass | 42991 ms | 10 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 94 ms | 1 / 1 |
| `containers` | ❌ fail | 25526 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 410 ms | 4 / 4 |
| `package-tests` | ✅ pass | 82 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 282 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 40219 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 838 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5423 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 554 ms | 89 / 92 |
| `webhooks` | ✅ pass | 96788 ms | 10 / 10 |
