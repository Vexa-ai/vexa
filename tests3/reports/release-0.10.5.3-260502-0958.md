# Release validation report — `0.10.5.3-260502-0958`

_Generated 2026-05-02T07:18:50.970904Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-0958` | 20 | 18 | 2 |
| `helm` | `0.10.5.3-260502-0958` | 12 | 8 | 4 |
| `lite` | `0.10.5.3-260502-0958` | 10 | 8 | 2 |
...
| status-completed | Meeting.status=completed after stop (not failed/stuck) | 10 | ❌ fail | helm: containers/status_completed: status=stopping reason= (expected completed/gone, OR failed+clean-stop) after ~24x5s poll |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 98 ms | 1 / 1 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 242 ms | 1 / 1 |
| `containers` | ✅ pass | 109268 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 613 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1171 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 109 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 317 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 93049 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 675 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5301 ms | 13 / 17 |
| `smoke-static` | ❌ fail | 634 ms | 88 / 92 |
...
| `webhooks` | ✅ pass | 97093 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 325 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 580 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 380 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ❌ fail | 240757 ms | 5 / 7 |
| `dashboard-auth` | ✅ pass | 1616 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3486 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 28581 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9177 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 32507 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 2877 ms | 89 / 92 |
| `webhooks` | ✅ pass | 103227 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 90 ms | 1 / 1 |
| `containers` | ❌ fail | 25405 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 456 ms | 4 / 4 |
| `package-tests` | ✅ pass | 79 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 259 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39332 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 1282 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 6555 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 653 ms | 88 / 92 |
| `webhooks` | ✅ pass | 96150 ms | 10 / 10 |
