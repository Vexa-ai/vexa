# Release validation report — `0.10.6-260512-1652`

_Generated 2026-05-12T14:23:25.724104Z from `tests3/.state/reports/`._
...
| `recordings-playback-url-canonical` | (any) | — | **✅ pass** |
| `drop-relational-recordings-tables` | (any) | — | **✅ pass** |
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.6-260511-2148` | 26 | 20 | 6 |
| `helm` | `—` | 0 | 0 | 0 |
| `lite` | `0.10.6-260512-1652` | 6 | 5 | 1 |
...
|------|:------:|---------:|---------------------:|
| `dashboard-playback-canonical` | ✅ pass | 142 ms | 1 / 1 |
| `no-media-files-table-references` | ✅ pass | 1432 ms | 1 / 1 |
| `no-recordings-table-references` | ✅ pass | 1289 ms | 1 / 1 |
| `smoke-static` | ❌ fail | 3221 ms | 89 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 334 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1336 ms | 15 / 15 |
| `v0.10.6.1-arm64-manifest-arm64_in_manifest` | ✅ pass | 100 ms | 1 / 1 |
| `v0.10.6.1-dashboard-master-backfill_complete` | ✅ pass | 125 ms | 1 / 1 |
| `v0.10.6.1-dashboard-master-prefers_master` | ❌ fail | 240 ms | 0 / 1 |
| `v0.10.6.1-dispatch-check-admin-deny-admin_bots_endpoint_honors_deny` | ✅ pass | 167 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-deny-bots_endpoint_honors_deny` | ✅ pass | 1177 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 268 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-eviction_retry_or_fail_clean` | ✅ pass | 129 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-rejection_under_30s` | ✅ pass | 136 ms | 1 / 1 |
| `v0.10.6.1-media-files-unique-constraint_declared` | ❌ fail | 138 ms | 0 / 1 |
| `v0.10.6.1-post-meeting-idempotency-fires_once_per_session` | ✅ pass | 163 ms | 1 / 1 |
| `v0.10.6.1-speak-defaults-defaults_propagate` | ✅ pass | 117 ms | 1 / 1 |
| `v0.10.6.1-speak-e2e-speak_delivers_audio` | ✅ pass | 283 ms | 1 / 1 |
| `v0.10.6.1-stale-audit-decisions_filed` | ❌ fail | 6398 ms | 0 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 779 ms | 9 / 9 |
| `v0.10.6.1-teams-modal-modal_dismissed` | ✅ pass | 137 ms | 1 / 1 |
| `v0.10.6.1-tts-auto-lang-detects_and_picks_voice` | ❌ fail | 134 ms | 0 / 0 |
| `v0.10.6.1-tts-auto-lang-voice_download_caches` | ❌ fail | 90 ms | 0 / 0 |
| `v0.10.6.1-tts-byo-playback-handles_wav_and_mp3` | ✅ pass | 130 ms | 1 / 1 |
| `v0.10.6.1-webhook-no-autotouch-no_autotouch` | ✅ pass | 130 ms | 1 / 1 |
| `v0.10.6.1-webm-duration-ebml_duration_present` | ✅ pass | 141 ms | 1 / 1 |
...
| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `smoke-env` | ✅ pass | 368 ms | 7 / 7 |
| `smoke-static` | ❌ fail | 3264 ms | 89 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 343 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1324 ms | 15 / 15 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 252 ms | 1 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 777 ms | 9 / 9 |
