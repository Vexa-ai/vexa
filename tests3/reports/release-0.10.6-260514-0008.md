# Release validation report — `0.10.6-260514-0008`

_Generated 2026-05-13T21:21:48.991153Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `any` | `—` | 0 | 0 | 0 |
| `compose` | `0.10.6-260514-0008` | 32 | 32 | 0 |
| `helm` | `—` | 0 | 0 | 0 |
| `lite` | `0.10.6-260514-0008` | 14 | 12 | 2 |
...
| admin-api-up | admin-api responds with a valid list | 10 | ❌ fail | lite: smoke-health/ADMIN_API_UP: HTTP 0 (expected 200); compose: smoke-health/ADMIN_API_UP: admin-api responds with valid token — user management and login work; helm: check ADMIN_API_UP not found … |
...
| `no-media-files-table-references` | ✅ pass | 1419 ms | 1 / 1 |
| `no-placeholder-transcription-token` | ✅ pass | 207 ms | 1 / 1 |
| `no-recordings-table-references` | ✅ pass | 1305 ms | 1 / 1 |
| `recording-finalizing-state` | ✅ pass | 135 ms | 1 / 1 |
| `recording-playback-url-canonical` | ✅ pass | 239 ms | 1 / 1 |
| `recordings-tables-dropped` | ✅ pass | 329 ms | 1 / 1 |
| `smoke-bot-transcription-roundtrip-roundtrip` | ✅ pass | 690 ms | 1 / 1 |
| `smoke-contract` | ✅ pass | 8521 ms | 27 / 27 |
| `smoke-env` | ✅ pass | 514 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 3766 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 2614 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 354 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1303 ms | 15 / 15 |
| `v0.10.6.1-arm64-manifest-arm64_in_manifest` | ✅ pass | 131 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-admin-deny-admin_bots_endpoint_honors_deny` | ✅ pass | 163 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-deny-bots_endpoint_honors_deny` | ✅ pass | 1194 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 283 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-eviction_retry_or_fail_clean` | ✅ pass | 118 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-rejection_under_30s` | ✅ pass | 143 ms | 1 / 1 |
| `v0.10.6.1-post-meeting-idempotency-fires_once_per_session` | ✅ pass | 166 ms | 1 / 1 |
| `v0.10.6.1-speak-defaults-defaults_propagate` | ✅ pass | 132 ms | 1 / 1 |
| `v0.10.6.1-speak-e2e-speak_delivers_audio` | ✅ pass | 212 ms | 1 / 1 |
| `v0.10.6.1-stale-audit-decisions_filed` | ✅ pass | 5976 ms | 1 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 805 ms | 9 / 9 |
| `v0.10.6.1-teams-modal-modal_dismissed` | ✅ pass | 123 ms | 1 / 1 |
| `v0.10.6.1-tts-auto-lang-detects_and_picks_voice` | ✅ pass | 2022 ms | 1 / 1 |
| `v0.10.6.1-tts-auto-lang-voice_download_caches` | ✅ pass | 738 ms | 1 / 1 |
| `v0.10.6.1-tts-byo-playback-handles_wav_and_mp3` | ✅ pass | 136 ms | 1 / 1 |
| `v0.10.6.1-webhook-no-autotouch-no_autotouch` | ✅ pass | 135 ms | 1 / 1 |
| `v0.10.6.1-webm-duration-ebml_duration_present` | ✅ pass | 146 ms | 1 / 1 |
| `walkability-smoke-compose` | ✅ pass | 1093 ms | 6 / 6 |
...
| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `dashboard-playback-canonical` | ✅ pass | 137 ms | 1 / 1 |
| `no-media-files-table-references` | ✅ pass | 1415 ms | 1 / 1 |
| `no-placeholder-transcription-token` | ✅ pass | 216 ms | 1 / 1 |
| `no-recordings-table-references` | ✅ pass | 1294 ms | 1 / 1 |
| `smoke-bot-transcription-roundtrip-roundtrip` | ✅ pass | 661 ms | 1 / 1 |
| `smoke-contract` | ❌ fail | 7300 ms | 9 / 27 |
| `smoke-env` | ✅ pass | 666 ms | 7 / 7 |
| `smoke-health` | ❌ fail | 4010 ms | 11 / 17 |
| `smoke-static` | ✅ pass | 2635 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 302 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1333 ms | 15 / 15 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 280 ms | 1 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 773 ms | 9 / 9 |
| `walkability-smoke-lite` | ✅ pass | 1133 ms | 6 / 6 |
...
| `scope-proof-gate-local` | ✅ pass | 366 ms | 1 / 1 |
