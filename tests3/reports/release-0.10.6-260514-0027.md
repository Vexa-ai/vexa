# Release validation report — `0.10.6-260514-0027`

_Generated 2026-05-14T11:16:29.837020Z from `tests3/.state/reports/`._
...
| `pre-release-security-dependency-floors` | compose, helm, lite | compose `advisory-dependency-floors/PRE_RELEASE_SECURITY_DEPENDENCY_FLOORS`: ✅ pass<br>lite `advisory-dependency-floors/PRE_RELEASE_SECURITY_DEPENDENCY_FLOORS`: ✅ pass<br>helm `advisory-dependency-floors/PRE_RELEASE_SECURITY_DEPENDENCY_FLOORS`: ⬜ missing | **⬜ missing** |
...
|------|-----------|-----------|--------|--------|
| `any` | `—` | 0 | 0 | 0 |
| `compose` | `0.10.6-260514-0008` | 34 | 34 | 0 |
| `helm` | `—` | 0 | 0 | 0 |
| `lite` | `0.10.6-260514-0027` | 15 | 15 | 0 |
| `none` | `0.10.6-260514-0027` | 12 | 12 | 0 |
...
| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `advisory-dependency-floors` | ✅ pass | 176 ms | 1 / 1 |
| `dashboard-playback-canonical` | ✅ pass | 1420 ms | 1 / 1 |
| `dashboard-recording-playback-ready` | ✅ pass | 8848 ms | 2 / 2 |
| `no-media-files-table-references` | ✅ pass | 1608 ms | 1 / 1 |
| `no-placeholder-transcription-token` | ✅ pass | 215 ms | 1 / 1 |
...
| `smoke-bot-transcription-roundtrip-roundtrip` | ✅ pass | 674 ms | 1 / 1 |
| `smoke-contract` | ✅ pass | 43155 ms | 27 / 27 |
| `smoke-env` | ✅ pass | 622 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 3869 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 2927 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 343 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1244 ms | 15 / 15 |
...
| `walkability-smoke-compose` | ✅ pass | 1037 ms | 6 / 6 |
...
| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `advisory-dependency-floors` | ✅ pass | 175 ms | 1 / 1 |
| `dashboard-playback-canonical` | ✅ pass | 1445 ms | 1 / 1 |
| `no-media-files-table-references` | ✅ pass | 1618 ms | 1 / 1 |
| `no-placeholder-transcription-token` | ✅ pass | 225 ms | 1 / 1 |
| `no-recordings-table-references` | ✅ pass | 1424 ms | 1 / 1 |
| `smoke-bot-transcription-roundtrip-roundtrip` | ✅ pass | 640 ms | 1 / 1 |
| `smoke-contract` | ✅ pass | 38692 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 641 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 4341 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 2960 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 351 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1057 ms | 15 / 15 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 257 ms | 1 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 801 ms | 9 / 9 |
| `walkability-smoke-lite` | ✅ pass | 1088 ms | 6 / 6 |
...
| `scope-proof-gate-local` | ✅ pass | 383 ms | 1 / 1 |
