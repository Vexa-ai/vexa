# Release validation report — `0.10.6-260511-2148`

_Generated 2026-05-11T18:53:52.876995Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.6-260511-2148` | 23 | 20 | 3 |
| `helm` | `—` | 0 | 0 | 0 |
| `lite` | `0.10.6-260511-2148` | 6 | 6 | 0 |
...
|------|:------:|---------:|---------------------:|
| `smoke-static` | ✅ pass | 3167 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 340 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1339 ms | 15 / 15 |
| `v0.10.6.1-arm64-manifest-arm64_in_manifest` | ✅ pass | 124 ms | 1 / 1 |
| `v0.10.6.1-dashboard-master-backfill_complete` | ✅ pass | 128 ms | 1 / 1 |
| `v0.10.6.1-dashboard-master-prefers_master` | ✅ pass | 248 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-admin-deny-admin_bots_endpoint_honors_deny` | ✅ pass | 169 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-deny-bots_endpoint_honors_deny` | ✅ pass | 1194 ms | 1 / 1 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 261 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-eviction_retry_or_fail_clean` | ✅ pass | 123 ms | 1 / 1 |
| `v0.10.6.1-gmeet-fast-fail-rejection_under_30s` | ✅ pass | 131 ms | 1 / 1 |
| `v0.10.6.1-media-files-unique-constraint_declared` | ✅ pass | 136 ms | 1 / 1 |
...
| `v0.10.6.1-speak-e2e-speak_delivers_audio` | ✅ pass | 281 ms | 1 / 1 |
| `v0.10.6.1-stale-audit-decisions_filed` | ❌ fail | 6068 ms | 0 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 766 ms | 9 / 9 |
| `v0.10.6.1-teams-modal-modal_dismissed` | ✅ pass | 134 ms | 1 / 1 |
| `v0.10.6.1-tts-auto-lang-detects_and_picks_voice` | ❌ fail | 132 ms | 0 / 0 |
| `v0.10.6.1-tts-auto-lang-voice_download_caches` | ❌ fail | 86 ms | 0 / 0 |
| `v0.10.6.1-tts-byo-playback-handles_wav_and_mp3` | ✅ pass | 132 ms | 1 / 1 |
| `v0.10.6.1-webhook-no-autotouch-no_autotouch` | ✅ pass | 132 ms | 1 / 1 |
| `v0.10.6.1-webm-duration-ebml_duration_present` | ✅ pass | 144 ms | 1 / 1 |
...
| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `smoke-env` | ✅ pass | 361 ms | 7 / 7 |
| `smoke-static` | ✅ pass | 2786 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 341 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1332 ms | 15 / 15 |
| `v0.10.6.1-dispatch-check-noop-noop_when_unset` | ✅ pass | 278 ms | 1 / 1 |
| `v0.10.6.1-static-greps` | ✅ pass | 754 ms | 9 / 9 |
