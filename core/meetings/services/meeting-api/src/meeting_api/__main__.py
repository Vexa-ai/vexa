...
def _attach_background_loops(
    ...
    *, session_factory=None, zaki_control_store=None, zaki_control_callback=None,
    ...
    is DELIBERATELY left unguarded — a Redis competing consumer whose single-delivery is already exact.
    """
    import math
