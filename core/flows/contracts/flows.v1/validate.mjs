#!/usr/bin/env node
/** gate:schema for flows.v1 — golden `<Shape>.<case>.json` validates against #/$defs/<Shape>. */
...
console.log(failed ? `flows.v1: ${failed} golden(s) FAILED` : `flows.v1: ${files.length} goldens conform`);
