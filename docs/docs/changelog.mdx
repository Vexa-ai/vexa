...
{/* docs-reflects: 0.12.16 — the released version these docs describe. CI (gate:docs-version) keeps
    this equal to Chart.yaml appVersion; the release version-bump updates it. */}

> 📌 **These docs reflect Vexa `v0.12.15`** — the latest released control-plane. Older self-hosts
