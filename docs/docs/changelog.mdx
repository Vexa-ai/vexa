...
{/* docs-reflects: 0.13.0 — the released version these docs describe. CI (gate:docs-version) keeps
    this equal to Chart.yaml appVersion; the release version-bump updates it. */}

> 📌 **These docs reflect Vexa `v0.13.0`** — the current release candidate control-plane. Older self-hosts
