...
an optional start time, an optional meeting link (Meet/Zoom/Teams/Jitsi/Telemost — parsed server-side), an
...
participant, on [**Google Meet**, **Zoom**, **Microsoft Teams**, **Jitsi Meet**, and
**Yandex Telemost**](/api/meetings#platforms).
