...
<CardGroup cols={2}>
  ...
  <Card title="Get a meeting's participants" icon="users" href="/how-to/meeting-participants">
    Build a speaker roster from the transcript — and know what it leaves out.
  </Card>
