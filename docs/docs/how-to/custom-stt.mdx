...
Self-hosted FunASR/SenseVoice gateways are a good fit when you need local Chinese, mixed
Chinese-English, Cantonese, Japanese, or Korean transcription.
...
For Fun-ASR-Nano or other FunASR checkpoints, set `TRANSCRIPTION_MODEL` to the model id your gateway
expects, for example `FunAudioLLM/Fun-ASR-Nano-2512`.
