...
In the Terminal's **Meetings** list, click **+ Plan a meeting**: give it a title, a time, and —
if you already have it — the Meet/Zoom/Teams link. The link is optional; attach it later from the
meeting's prep view.
...
The meeting appears under **Upcoming** with a `Scheduled` badge. Clicking it opens its **prep
view** — title, time, link, the auto-join toggle, and the workspace section below.

<Note>
Meetings on your calendar can create these records for you — see
