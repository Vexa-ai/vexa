...
stream the transcript from `GET /agent/meeting/stream` and ask the agent about it. See
[Follow a live meeting](/how-to/live-copilot) and the [Agent API](/api/agent).
