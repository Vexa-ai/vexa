...
description: "Capture a Google Meet, Zoom, or Teams call in real time."
---

A Vexum bot joins a call like any participant and streams back a **speaker-attributed** transcript. No
