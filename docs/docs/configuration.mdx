...
| `VEXA_FLOWS_DB_URL` | — | Postgres DSN for the ten flows tables, e.g. `postgresql+pg8000://user:password@postgres:5432/flows`. The stack's own database is the expected home. |
