...
Stop pasting links: give Vexum your calendar's **secret ICS address** (Google Calendar → Settings →
*Secret address in iCal format*) and every upcoming meeting with a Meet/Zoom/Teams link imports on
its own — and the bot **auto-joins at start time**.
