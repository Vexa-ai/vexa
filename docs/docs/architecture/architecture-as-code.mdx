...
The Vexum runtime is modeled as code using **[FINOS CALM](https://calm.finos.org/)** (Common Architecture
Language Model). There is **one chart** — the repo-root
[`architecture.calm.json`](https://github.com/Vexa-ai/vexa-core/blob/main/architecture.calm.json) — the
single source of truth; [`calm/`](https://github.com/Vexa-ai/vexa-core/tree/main/calm) holds the governance
...
[`docs/views/`](https://github.com/Vexa-ai/vexa-core/tree/main/docs/views) deterministically, and
