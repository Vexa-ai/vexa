...
> [`DELIVERY-COMPLIANCE.md`](/governance/delivery-compliance).
...
· *Gate:* [`DELIVERY-COMPLIANCE.md`](/governance/delivery-compliance) — the live principle→gate→status map.
...
has its operational protocol: [`DELIVERY-PREPARE.md`](/governance/delivery-prepare) (queue item → prepared
issue) and [`DELIVERY-TAKE.md`](/governance/delivery-take) (delivered PR → verdict against the floor).
...
[`docs/adr/`](https://github.com/Vexa-ai/vexa/tree/main/docs/adr) (process decisions live beside build decisions), and update the compliance map. A
