...
- **[PREPARE](/governance/delivery-prepare)** — signal → spec. Turns one queue item (a raw
...
- **[TAKE](/governance/delivery-take)** — PR → verdict. Triages a delivered PR against its
...
|---|---|---|---|
| Discover | remote agent / human | [`llms.txt`](https://github.com/Vexa-ai/vexa/blob/main/llms.txt) (pre-clone entrypoint) · this site's `/llms.txt` · README | — |
...
| Pick | contributor's agent | one GraphQL call ([contributing](/roadmap/contributing)) | — |
...
- **The D-book: process.** The state-label machine (exactly one `state:` per issue), acceptance
  ...
  [Delivery compliance](/governance/delivery-compliance).
