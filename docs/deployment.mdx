...
Before self-hosting, consider the hosted service at [vexa.ai](https://vexa.ai) — get an API key at [vexa.ai/account](https://vexa.ai/account) and start sending bots immediately. No infrastructure needed.
