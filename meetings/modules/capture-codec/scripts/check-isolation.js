...
// a Node builtin, or a DECLARED dep (dependencies OR devDependencies). capture-codec
// is the shared wire codec; it is PURE and zero-dep, so this proves it pulls in
// nothing — no brick internals, no contract package, no monolith back-import.
