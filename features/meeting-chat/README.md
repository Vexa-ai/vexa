...
|---|-------|--------|---------|-------|--------|----------|--------------|------|
| 1 | POST /chat sends message visible to participants | 30 | ceiling | 0 | UNTESTED | Not tested in 2026-04-08 validation run. No chat test target. | — | — |
| 2 | GET /chat returns messages from meeting | 30 | ceiling | 0 | UNTESTED | Not tested. BUG #29 fix deployed. | — | — |
| 3 | Works on GMeet and Teams | 20 | — | 0 | UNTESTED | Not tested. | — | — |
| 4 | Chat messages persisted after meeting ends | 20 | — | 0 | UNTESTED | Not tested. | — | — |
