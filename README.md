...
[Meeting API](#meeting-api) • [Agent API](#agent-api) • [Runtime API](#runtime-api) • [Quickstart](#quickstart) • [Docs](https://docs.vexa.ai) • [Roadmap](#roadmap) • [Discord](https://discord.gg/Ga9duGkVz9)
...
| **Post-meeting automation #remove** | Meetings trigger action: summarize, create tickets, push to Slack/CRM — no human needed     |
| **Proactive agents #remove**        | Scheduler + calendar integration: agents join meetings on schedule, act without being asked |
...
- **Automation builders:** Post-meeting pipelines with n8n, webhooks, and agent containers
  - Tutorial: [https://vexa.ai/blog/google-meet-transcription-n8n-workflow](https://vexa.ai/blog/google-meet-transcription-n8n-workflow)
